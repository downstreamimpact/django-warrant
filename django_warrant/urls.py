...
urlpatterns = (
    re_path(r'^login/$', auth_views.LoginView, {'template_name': 'warrant/login.html'}, name='login'),
    ...
    re_path(r'^profile/subscriptions/$', MySubscriptions.as_view(), name='subscriptions'),
